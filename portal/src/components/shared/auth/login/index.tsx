...
export const LoginForm = ({ lang }: { lang: string }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="ms-auto flex items-center justify-between px-6 pt-2 pb-6">
          <button
            type="button"
            onClick={() => {
              closeModal("login");
      ...
      <div className="border-t border-gray-200 mt-8 py-4">
        <div className="flex flex-col gap-y-2 text-base">
          <p className="text-secondary">{t("forms.dont_have_account")}</p>
          <button
            type="button"
            onClick={() => {
              closeModal("login");
